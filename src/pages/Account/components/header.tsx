...
import {
  AccountAddress, AccountHeaderContainer, AccountInfoContainer,
  FirstInfoColumn, ListElement, ListLabel, ListValue, SecondInfoColumn,
  SecondaryBalance, Title, Value,
} from './header.style';
